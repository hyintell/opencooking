...
def main_loop(arglist):
    ...
    print(arglist)
    env = gym.envs.make("opencooking:overcookedEnv-v0", num_agents=arglist.num_agents, level=arglist.level, arglist=arglist)
    obs = env.reset()
...
if __name__ == '__main__':
    ...
    if arglist.play:
        env = gym.envs.make("opencooking:overcookedEnv-v0", arglist=arglist)
        env.reset()
